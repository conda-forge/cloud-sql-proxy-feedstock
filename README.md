...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cloud-sql-proxy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cloud-sql-proxy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add cloud-sql-proxy
# for installing globally
pixi global install cloud-sql-proxy
```
...
It is possible to list all of the versions of `cloud-sql-proxy` available on your platform:
...
```
pixi search cloud-sql-proxy --channel conda-forge
```
